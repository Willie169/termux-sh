...
2. **Vim configuration**: Install [vimrc by Amir Salihefendic (amix)](https://github.com/amix/vimrc) with my customization and GitHub Copilot plugin for both Vim and Neovim if not `VIMRC=0`.
