...
- [`debian-texlive.sh`](debian-texlive.sh): Install `texlive-full`, `pandoc`, `NotoSansCJK-VF.otf.ttc`, `NotoSansMonoCJK-VF.otf.ttc`, and `STIXTwoMath-Regular.otf`. Invoked for the `debian2` proot environment in [Termux Setup](#termux-setup).
