...
- Approximately 34GB of storage space.
...
- **[debian-texlive.sh](debian-texlive.sh)**: Installs `texlive-full`, `pandoc`, and `mediawiki2latex`. Used for the `debian2` proot in [Termux Setup All](#termux-setup-all).
