...
- [`debian-texlive.sh`](debian-texlive.sh): Install `texlive-full` and `pandoc`; download `NotoSansCJK-VF.otf.ttc` and `STIXTwoMath-Regular.otf`. Invoked for the `debian2` proot environment in [Termux Setup](#termux-setup).
