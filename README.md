...
Follow the screen guide to complete it. If you see a dancing parrot followed by a "termux-setup-all.sh finished" on screen, pull down the notification bar, and tap `exit` on the notification of Termux. Now, you can restart Termux and enjoy it.
