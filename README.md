...
<li>Approximately 31.3 GB more for <code>UBUNTUINSTALL=1</code>.</li>
<li>Approximately 31.3 GB more for <code>DEBIANINSTALL=1</code>.</li>
<li>Approximately 39.4 GB in total for the default configuration with <code>XFCE=1</code>, <code>ANDROID=1</code>, and
...
- [`xmrig-install.sh`](xmrig-install.sh): Builds [XMRig](https://github.com/xmrig/xmrig), an open source, cross-platform RandomX, KawPow, CryptoNight and GhostRider CPU/GPU miner, RandomX benchmark, and stratum proxy, on Termux.
