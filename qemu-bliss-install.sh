...
mkdir ~/bliss && cd ~/bliss || exit
wget https://sourceforge.net/projects/blissos-x86/files/Official/BlissOS15/Gapps/Generic/Bliss-v15.9.2-x86_64-OFFICIAL-gapps-20241012.iso/download -O Bliss-v15.9.2-x86_64-OFFICIAL-gapps-20241012.iso
