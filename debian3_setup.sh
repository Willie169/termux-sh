apt update -y && apt upgrade -y && apt install build-essential cmake python3-all-dev python3-venv openjdk-11-jdk curl wget git nano vim iproute2 procps grep libboost-all-dev gdb tmux nodejs -y
