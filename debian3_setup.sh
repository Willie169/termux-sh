apt update -y && apt upgrade -y && apt install python3-all-dev python3-venv build-essential cmake curl wget git nano vim iproute2 procps grep libboost-all-dev gdb tmux -y
