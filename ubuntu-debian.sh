...
gh_latest marcosnils/bin 'bin_*_linux_arm64'
chmod +x bin_*_linux_arm64
echo ~/.local/bin | ./bin_*_linux_arm64 install github.com/marcosnils/bin
rm bin_*_linux_arm64*
