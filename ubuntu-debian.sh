...
apt update
DEBIAN_FRONTEND=noninteractive apt purge neovim rustup tree-sitter-cli yq -y -o Dpkg::Options::="--force-confnew" -o Dpkg::Options::="--force-overwrite"
