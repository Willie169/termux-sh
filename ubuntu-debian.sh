...
npm config set allow-scripts=deno,opencode-ai --location=user && npm i -g bash-language-server deno dockerfile-language-server-nodejs http-server neovim opencode-ai prettier pyright @openai/codex
