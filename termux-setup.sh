...
perl -0777 -pe 's/(###############\n# Extra keys\n###############\n)/$1\nextra-keys = \[ \[ \{ key: ESC, popup: ":q" \}, \{ key: KEYBOARD, popup: ":q\\n" \}, \{ key: "EOF", popup: ":wq" \}, \{ key: "Z", popup: \{ macro: "CTRL t", display: "CTRL t" \} \}, \{ key: ":V", popup: \{ macro: "CTRL 1", display: "CTRL 1" \} \}, \{ key: "d\\\$", popup: \{ macro: "CTRL 2", display: "CTRL 2" \} \}, \{ key: "yG", popup: "yy" \}, \{ key: "...", popup: \{ macro: "^" \} \} \], \[ \{ key: DRAWER, popup: ":" \}, \{ key: "\/", popup: "\\\\\\\\" \}, \{ key: "\`", popup: "\`\`\`" \}, \{ key: DEL, popup: BKSP \}, \{ key: HOME, popup: "clear" \}, \{ key: UP, popup: \{ macro: "CTRL UP", display: "Up" \} \}, \{ key: END, popup: ENTER \}, \{ key: PGUP, popup: "gg" \} \], \[ \{ key: TAB, popup: \{ macro: "CTRL d", display: "Send EOF" \} \}, \{ key: "~", popup: \{ macro: "CTRL \\\\\\\\", display: "SIGQUIT" \} \}, \{ key: CTRL, popup: \{ macro: "CTRL c", display: "SIGINT" \} \}, \{ key: ALT, popup: \{ macro: "CTRL z", display: "SIGTSTP" \} \}, \{ key: LEFT, popup: \{ macro: "CTRL LEFT", display: "Left" \} \}, \{ key: DOWN, popup: \{ macro: "CTRL DOWN", display: "Down" \} \}, \{ key: RIGHT, popup: \{ macro: "CTRL RIGHT", display: "Right" \} \}, \{ key: PGDN, popup: "G" \} \] \]\n/s' ~/.termux/termux.properties > tmp
