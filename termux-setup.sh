...
mv ~/bashrc.sh ~/.bashrc
source ~/.bashrc
[ "$VIMRC" -eq 0 ] || git clone --depth=1 https://github.com/amix/vimrc.git ~/.vim_runtime && sh ~/.vim_runtime/install_awesome_vimrc.sh && echo 'set mouse=a' | tee ~/.vim_runtime/my_configs.vim > /dev/null
