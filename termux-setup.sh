...
mkdir -p ~/.shortcuts && cp ~/termux-sh/DOTshortcuts/* ~/.shortcuts && cp ~/termux-sh/DOTshortcuts/* ~ && mv ~/bashrc.sh ~/.bashrc && chmod +x ~/.bashrc && source ~/.bashrc && chmod +x ~/.shortcuts/* && chmod +x ~/*.sh
